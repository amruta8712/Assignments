...
let mySAccount1 = new SavingAccount("1", "Amruta", 10, 4000);
let mySAccount2 = new SavingAccount("2", "Amruta", 10, 4000);
let myCAccount1 = new CurrentAccount("3", "Amruta", 10, 3000);
